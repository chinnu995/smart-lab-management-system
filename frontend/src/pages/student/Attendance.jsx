...
import { Camera, QrCode, Play, Upload } from 'lucide-react';
      ...
      <div className="grid md:grid-cols-2 gap-5">
        <div className="card">
          <h3 className="font-semibold mb-3 flex items-center gap-2">
            <QrCode size={18} /> Mark via QR
          </h3>
          <form onSubmit={submitQR} className="flex flex-col gap-3">
            <textarea
              className="input h-24"
              placeholder="Paste QR token shown by faculty…"
              value={qrToken}
        ...
        <div className="card">
          ...
          <div className="mb-3">
            ...
            <select
              ...
              className="w-full text-sm bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded p-2 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-1 focus:ring-blue-500"
              value={selectedLab}
