...
const SUBJECTS = ['ADA', 'DBMS', 'LATEX', 'MICROCONTROLLER', 'MONGODB', 'AI', 'JAVA'];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-violet-600 to-purple-700 text-white p-6 rounded-2xl shadow-lg relative overflow-hidden">
        ...
        <div className="z-10 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold">AI Test Generator</h2>
            <p className="text-sm text-purple-100 mt-0.5">Generate MCQ tests powered by Google Gemini AI</p>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div className="flex items-center gap-4 text-[11px] text-slate-500 dark:text-slate-400 mb-2">
                  <span className="flex items-center gap-1">
                    <Brain size={13} /> {t.question_count} Q
                  </span>
                  <span className="flex items-center gap-1">
